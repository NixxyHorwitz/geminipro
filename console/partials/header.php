...
<aside class="sidebar" id="sidebar">
  ...
  <nav class="sidebar__nav">
    ...
    <a href="/console/identity.php" class="sidebar__link <?= $activePage === 'identity' ? 'active' : '' ?>">
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="8" r="5"/><path d="M3 21v-2a9 9 0 0118 0v2"/></svg>
      Site Identity
    </a>
    ...
    <a href="/console/errorlog.php" class="sidebar__link <?= $activePage === 'errorlog' ? 'active' : '' ?>">
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M10.29 3.86L1.82 18a2 2 0 001.71 3h16.94a2 2 0 001.71-3L13.71 3.86a2 2 0 00-3.42 0z"/><line x1="12" y1="9" x2="12" y2="13"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg>
      Error Log
      <?php
      $logFile = dirname(__DIR__) . '/error_log.txt';
      if (file_exists($logFile) && filesize($logFile) > 0) {
          echo '<span class="sidebar__badge" style="background:#f29900">!</span>';
      }
      ?>
    </a>
  </nav>
